...
use utf8;
package Asterisk::Schema::Result::QueueMemberTable;
...
Asterisk::Schema::Result::QueueMemberTable
...
=head1 TABLE: C<queue_member_table>

=cut

__PACKAGE__->table("queue_member_table");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:McChY3I12BUptxyhH+CILw
